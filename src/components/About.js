...
export default function About() {
    return (
        <div className="scale-75 -mt-8">
            <div className="rounded-xl bg-[#04d7c9] 2xl:mx-auto 2xl:container 2xl:px-20 px-6 ">
                    ...
                    <div className="md:py-20 xl:w-1/2 sm:w-1/2 lg:mr-20 md:mr-6 flex flex-col md:items-end items-center justify-center xl:mr-28">
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <div className="mt-7 flex flex-col items-center">
                                ...
                                <p className="text-base leading-6 mt-2 text-center text-gray-600 sm:w-96 w-full">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Suscipit, quo!</p>
                            </div>
                        </div>
                    </div>
